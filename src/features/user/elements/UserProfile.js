      ...
      <div className="mx-auto mt-10 max-w-3xl p-4">
        ...
        <div className="bg-white shadow-md p-6 rounded-lg mb-6">
          ...
          <p className="text-gray-600 mb-2">{userInfo.email}</p>
            <p className="text-red-600 font-semibold">Role: {userInfo.role}</p>
        </div>
        ...
        <div className="bg-white shadow-md p-6 rounded-lg mb-6">
          <button
            ...
            className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-600"
          >
            Add New Address
          </button>
          {showAddAddressForm ? (
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                      <button
                        ...
                        type="submit"
                        className="rounded-md px-3 py-2 text-sm font-semibold text-grey shadow-sm hover:bg-grey-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
                      >
                        Cancel
                      </button>
                      <button
